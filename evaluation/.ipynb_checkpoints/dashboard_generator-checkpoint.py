...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        results_file = "/home/cdsw/retrieve_developments/retrieve_070126/output/evaluation_results_new.json"

    if os.path.exists(results_file):
        print(f"Generating dashboard from: {results_file}")
        generate_dashboard(results_file, "/home/cdsw/retrieve_developments/retrieve_070126/output/dashboard.html")
