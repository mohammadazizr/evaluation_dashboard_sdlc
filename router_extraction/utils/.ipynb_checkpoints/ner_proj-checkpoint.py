...
with open('/home/cdsw/retrieve_developments/retrieve_070126/router_extraction/exports/proj_coll.json', 'r') as f:
    # Parsing the JSON file into a Python dictionary
    data = json.load(f)
...
class EntityExtractor:
    ...
    def extract(self, user_question: str, level_init_filters: dict) -> dict:
        try:
            ...
            with open("/home/cdsw/retrieve_developments/retrieve_070126/router_extraction/output/proj_entity_output.json", mode="w", encoding="utf-8") as f:
