...
with open('embed_push_qdrant/ner_4_steps/exports/doc_type_coll.json', 'r') as f:
    # Parsing the JSON file into a Python dictionary
...
#         raw_output = response.choices[0].message.content.strip()
        ...
        try:
            ...
            with open("embed_push_qdrant/ner_4_steps/doc_entity_output.json", mode="w", encoding="utf-8") as f:
...
if __name__ == "__main__":
    ...
    with open('embed_push_qdrant/ner_4_steps/proj_entity_output.json', 'r') as f:
        # Parsing the JSON file into a Python dictionary
        data_proj = json.load(f)
    
    with open('embed_push_qdrant/ner_4_steps/act_entity_output.json', 'r') as f:
        # Parsing the JSON file into a Python dictionary
        data_act = json.load(f)
    
    with open('embed_push_qdrant/ner_4_steps/level_init_filters.json', 'r') as f:
        # Parsing the JSON file into a Python dictionary
    ...
    with open("embed_push_qdrant/ner_4_steps/doc_entity_output.json", mode="w", encoding="utf-8") as write_file:
